                ...
                <div>
                  ...
                  if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                        echo "<b>Sr No: </b>" . $row["sr_no"]. " - <b>Book Name: </b>" . $row["book_name"]. " - <b>Genre: </b>" . $row["genre"]. " - <b>Author Name: </b>" . $row["author_name"].  " - <b>Publisher:</b> " . $row["publisher"]. " - <b>ISBN:</b> " . $row["isbn"]. " - <b>Timestamp:</b> " . $row["book_timestamp"]. " <br>";
                      }
                    } else {
                      echo "0 results";
                    }
